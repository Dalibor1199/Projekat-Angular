...
public class Kontroler {
	...
	public ResponseEntity<Response> login(@RequestParam(name="username") String username, @RequestParam(name="password") String password) {
	...
	public ResponseEntity<List<Destinacija>> filter(@RequestParam(name = "naziv") String naziv,
			@RequestParam(name = "cena") String cenaString, @RequestParam(name = "date") String dateString) throws ParseException {
		...
		if (!naziv.equals("") && !cenaString.equals("") && !dateString.equals("")) {
			...
			glavnaLista=lista.stream().filter(x-> x.getNaziv().contains(naziv) && x.getCena()<=cena && 
					x.getDatum().toString().equals(dateString))
		...
		//naziv i cena
			...
			glavnaLista=lista.stream()
					.filter(x->x.getNaziv().contains(naziv) && x.getCena()<=cena).collect(Collectors.toList());
		}
		
		//naziv i datum
		else if (!naziv.equals("") && cenaString.equals("") && !dateString.equals("")) {
			glavnaLista=lista.stream()
					.filter(x->x.getNaziv().contains(naziv) && x.getDatum().toString().equals(dateString)).collect(Collectors.toList());
		}
		...
		//cena i datum 
			...
			int cena=Integer.parseInt(cenaString);
			glavnaLista=lista.stream()
					.filter(x->x.getDatum().toString().equals(dateString) && x.getCena()<=cena).collect(Collectors.toList());
		}
		...
		//naziv
			...
			glavnaLista=lista.stream()
					.filter(x->x.getNaziv().contains(naziv)).collect(Collectors.toList());
		}
		...
		//cena
			...
			int cena=Integer.parseInt(cenaString);
			glavnaLista=lista.stream()
					.filter(x->x.getCena()<=cena).collect(Collectors.toList());
		}
		
		//datum
		else if (naziv.equals("") && cenaString.equals("") && !dateString.equals("")) {
			glavnaLista=lista.stream()
					.filter(x->x.getDatum().toString().equals(dateString)).collect(Collectors.toList());
		}
	...
	@PostMapping("addDest") 
	public ResponseEntity<Destinacija> addDest(@RequestParam(name = "naziv") String naziv, @RequestParam(name = "cena") String cena,
				@RequestParam("datum") String datum, @RequestParam(name = "slika") String slika) throws ParseException {
	...
	public ResponseEntity<Boolean> updateDest(@RequestParam(name = "naziv") String naziv, @RequestParam(name = "cena") String cenaString,
			@RequestParam(name = "datum") String datumString, @RequestParam(name = "slika") String slika) throws ParseException {
